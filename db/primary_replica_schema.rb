...
where: '(finished_at IS NULL)'
  ...
  create_table 'posts', force: :cascade do |t|
    ...
    t.index ['publication_id', 'blob_path', 'version'],
name: 'index_posts_on_publication_id_and_blob_path_and_version', unique: true
  ...
  create_table 'revisions', force: :cascade do |t|
    ...
    t.index ['publication_id', 'post_id', 'number'], name: 'index_revisions_on_publication_id_and_post_id_and_number',
unique: true
