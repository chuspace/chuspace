...
name: :index_good_jobs_on_queue_name_and_scheduled_at, algorithm: :concurrently
    add_index :good_jobs, [:active_job_id, :created_at], name: :index_good_jobs_on_active_job_id_and_created_at,
algorithm: :concurrently
    add_index :good_jobs, :concurrency_key, where: '(finished_at IS NULL)',
name: :index_good_jobs_on_concurrency_key_when_unfinished, algorithm: :concurrently
