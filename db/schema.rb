...
ActiveRecord::Schema[7.0].define(version: 2022_05_22_142540) do
  ...
  create_table "kvs", force: :cascade do |t|
    ...
    t.text "value"
    t.text "default"
    t.text "data_type", default: "string", null: false
  ...
  create_table "publications", force: :cascade do |t|
    ...
    t.datetime "created_at", null: false
    t.datetime "updated_at", null: false
    t.enum "visibility", default: "public", null: false, enum_type: "publication_visibility_enum_type"
  ...
  add_foreign_key "publishings", "users", column: "author_id"
