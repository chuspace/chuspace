...
class Avatar::ComponentTest < ViewComponent::TestCase
  ...
  def test_component_renders_something_useful
    assert_equal(
      %(
        <div class="avatar"> <lazy-image class="w-8 h-8 rounded-full" rounded src="//secure.gravatar.com/avatar/d79899c0fc43470b3a83e2928034f2dc?d=identicon&amp;s=64" title="GT"> </lazy-image> </div>
      ).squish,
