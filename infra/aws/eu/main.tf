...
module "eu_central_shared_resources" {
  source = "../shared/vpc"
...
module "eu_central_servers" {
  source = "../shared/server"

  region = "eu-central-1"
  name   = "chuspace-app"

  server_security_group_id  = module.eu_central_shared_resources.app_sg_id
  public_subnets            = module.eu_central_shared_resources.public_subnets
  iam_instance_profile_name = module.eu_central_shared_resources.iam_instance_profile_name
  vpc_id                    =  module.eu_central_shared_resources.vpc_id
